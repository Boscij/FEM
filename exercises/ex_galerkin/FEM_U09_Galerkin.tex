...
\hypersetup{
  ...
  pdftitle={FE-Grundlagen: U05 Galerkin},
  colorlinks=true,
  urlcolor=blue
}
...
Der Stab der Länge~$L$ ist wie abgebildet am rechten Ende mit einer vorgegebenen Verschiebung $\bar{u}_L$ eingespannt.
...
\begin{enumerate}[label=\protect\circled{\arabic*}]
  ...
  \item Geben Sie die gemäss \emph{Galerkin} zu \eqref{eqn:Trial} passende Gewichtungsfunktion an
    ...
    \end{equation}
  \item Arbeiten Sie die \emph{Verschiebungsrandbedingung} in die Ansatzfunktion \eqref{eqn:Trial} ein
    \begin{align}
