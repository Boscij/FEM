...
\begin{frame}{Warum FEM?\;—\;Rückblick Festigkeitslehre}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.28\textwidth}
      \centering
      % TODO: Bild 30\% Breite
      \only<2->{\includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio]{../Grafiken/KomplexeGeometrie.png}}
...
\begin{frame}{FEM-Workflow (Übersicht)}
  ...
  \begin{tikzpicture}[
    ...
    \node[wfstep] (p4) at (0,-0.7) {Elementsteifigkeitsmatrix $\underline{\underline{k}}^e$ berechnen};
    \node[wfstep] (p5) at (0,-1.6) {Global assemblieren $\underline{\underline{K}}$ und $\mathbf{f}$};
    \node[wfstep] (p6) at (0,-2.5) {Gleichungssystem lösen $\underline{\underline{K}}\,\mathbf{u}=\mathbf{f}$};
